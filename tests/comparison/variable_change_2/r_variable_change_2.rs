...
impl Default for variable_change_2 {
    fn default() -> Self {
...
impl variable_change_2 {
    ...
    pub fn change_me(&mut self) {
        self.r#traffic_state_i = bool::try_from(true).unwrap();
        self.r#hour = i8::try_from(19).unwrap();
        self.r#trains_i = i16::try_from(22).unwrap();
        self.r#traffic_state_i = bool::try_from(false).unwrap();
        self.r#traffic_state_i = bool::try_from(true).unwrap();
    }
}
